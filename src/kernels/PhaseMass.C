...
PhaseMass::computeQpResidual()
{
  ...
  return -0.5 * (  _grad_u_vel[_qp](0) - _grad_phase[_qp](0) * _u_vel[_qp] * _grad_u_vel[_qp](0)
              + _grad_v_vel[_qp](1) - _grad_phase[_qp](1) * _v_vel[_qp] * _grad_v_vel[_qp](1)
              + _grad_w_vel[_qp](2) - _grad_phase[_qp](2) * _w_vel[_qp] * _grad_w_vel[_qp](2));
}
